    ...
    return (
        <View style={{flexGrow: 1}}>
            <ScrollView contentContainerStyle={styles.container}>
                ...
                <Image style={styles.imagem} source={require('./image/tela2.png.jpeg')} />
                ...
                <Image style={styles.imagem} source={require('./image/tela2oleo.png.jpeg')} />
...
Uma vez na semana fazemos a coleta em locais mapeados como grandes geradores, que são as lanchonetes, restaurantes e bares, e também recebemos diretamente na Secretaria óleo usado dos munícipes.</Text>
                ...
                <Image style={styles.imagem} source={require('./image/tela4eletronico.png.jpeg')} />
